  ...
  return (
    <div style={{height: "650px"}} className='h-200 d-flex gap-2'>
        <div style={{maxWidth: "50%"}} className=' d-flex gap-5 shorflex header-light-pink'>
            <div style={{width: "300px"}} className=' shorflex1' >
        ...
        <div  style={{maxWidth: "50%"}} className='d-flex gap-2 shorflex flex-column'>
           <div className='d-flex shorflex gap-2'>
            ...
            <div className="shorflex header-pink d-flex justify-content-start align-items-center">
                    <div className='d-flex flex-column text-start p-4'>
                        <h3 className='header-bold m-0'>Cantilever chair's</h3>
                        <p>450 items</p>
                        <div>
                        <a className='text-bold text-decoration-none bb-red'>Shop Now</a>
                        </div>
                ...
                <div className="shorflex header-blue d-flex justify-content-start align-items-center">
                    <div className='d-flex flex-column text-start p-4'>
                        <h3 className='header-bold m-0'>Accesories</h3>
                        <p>450 items</p>
                        <div>
                        <a className='text-bold text-decoration-none bb-red'>Shop Now</a>
                        </div>
